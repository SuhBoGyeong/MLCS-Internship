...
f_n=442  ##same as len(risk_factor_list)
...
x_total=np.load('./data_imputed_paper_10_1.npy')
y_total=np.load('./data_paper_y_10_1.npy')

x_total=tf.keras.utils.normalize(x_total)
print(x_total.shape)
print(y_total.shape)
...
model.add(Dense(1024, input_shape=(f_n,)))
